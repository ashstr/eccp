...
<?php                
 ...
 $exID = intval($_GET["ExamID"]);
	...
	}else{ echo "<p style='padding-left:10px;padding-top:15px;'>This Question Has Been Added Before Please Try Another Question To Add</p>";
...
<div class="action_bar" style="height:25px; padding-left:10px; ">
					<input type="button" value="Done, Close This Page"  onclick="closeme();"  class="button_small bluishBtn fl_left">
                </div>
            </div>
        </div>
    </div> 
