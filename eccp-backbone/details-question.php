...
<?php 
	...
	$catId = intval($cleanHTML03); 
		 ...
		 /// Get Correct Answer
		 $tips     = mysql_query("SELECT * FROM `mc_so` WHERE `qid` = '$catId' and `flag` = '2'  LIMIT 0 , 1  ");
		 $tipsFet  = mysql_fetch_array($tips);

//		 $ti  	  = mysql_query("SELECT * FROM `mc_so` WHERE `qid` = '$catId' and `flag` = '2' LIMIT 0 , 1  ");
//		 $Explan  = mysql_fetch_array($ti);
//		 $tipss   = $Explan["option"];
...
<li>
   <label>Course</label>
     <div class="form_input">
     <select name='sec' id="sec" dir="ltr" size="1" style="width:600px" disabled>
<?php 
 ...
 <div style="margin:30px 10px 10px 10px;">
  ...
  <li>
    	...
    	<div class="widget">
            ...
            <div class="widget_body">
                <div id="container">
                	<textarea name="Explanation" id="Explanation" rows="8" cols="60"><?php echo $Explanation; ?></textarea>
                </div>
            </div>
        </div>
    </div>
 ...
 $numsv  = mysql_num_rows($wrong0);
   ...
   while($wrong1=mysql_fetch_array($wrong0) ){ ?> 
      <li>
       <label>Choices <?php echo $initiator; ?></label>
        <div class="form_input">
            <input id="op<?php echo $initiator; ?>" name="op<?php echo $initiator; ?>" class="in_error"  type="text" value="<?php echo $wrong1["option"]; ?>" title="" disabled>
        </div>
      </li>
     <?php
	  $initiator++;
  ...
  <li>
   <label>Tips & Help</label>
     <div class="form_input">
     <textarea name="tips" id="tips" cols="10" rows="5"  class="tip_east"><?php echo $tipsFet["tips"]; ?></textarea>
     </div>
  </li>                    
...
<!--<div class="widget_body">
  <div class="action_bar" align="center">
   <input name="Update" type="submit" value="Insert This Now" class="button_small bluishBtn">
     	...
     	<input type="hidden" name="QID"    value="<?php //=$qID; ?>">
     	<?php
