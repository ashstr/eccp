 ...
 <div class="one_wrap">
  ...
  <div class="widget_body">
    ...
    <table class="activity_datatable" width="100%" border="0" cellspacing="0" cellpadding="8">
        <tr>
            <th width="7%">ID</th>
            <th width="80%" align="left">Chapter/Sub Title</th>
            <!--<th width="44%">Date</th>-->
            </tr>
<?php
 ...
 $Sql = mysql_query("select * from `subject` where `parent_cat` = '$catId' LIMIT 0, 120 ");
   while ($Row = mysql_fetch_array($Sql)){
	  $ID_main=$Row["ID"]; ?>
		<tr>
		  <td align="center"><?php echo $Row["ID"]; ?></td>
		  <td align="left">
          	<a href="fill-question.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row["ID"]; ?>&ExamID=<?php echo $_GET["ExamID"]; ?>" style="font-family:Tahoma; font-weight:bold;"><?php echo $Row["title"]; ?></a></td>
 ...
 <?php
  $Sql2 = "select * from `subject` where `parent_cat` = '$ID_main' ";
		...
		<tr>
		  ...
		  <td align="left">
          	<a href="fill-question.php?SESSION=ECCP&SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row2["ID"]; ?>&ExamID=<?php echo $_GET["ExamID"]; ?>" style="font-family:Tahoma; font-weight:bold;">&nbsp;&nbsp;<?php echo $Row["title"]."&nbsp;>&nbsp;"; echo $Row2["title"]; ?></a></td>
	...
	$ID_main=$Row3["ID"];?>
		...
		<tr>
		  ...
		  <td align="left">
            <a href="fill-question.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row4["ID"]; ?>&ExamID=<?php echo $_GET["ExamID"]; ?>" style="font-family:Tahoma; font-weight:bold;">&nbsp;&nbsp;
		...
		<tr>
		  ...
		  <td align="left">
            <a href="fill-question.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row5["ID"]; ?>&ExamID=<?php echo $_GET["ExamID"]; ?>" style="font-family:Tahoma; font-weight:bold;">&nbsp;&nbsp;
			  <?php
		...
		<tr>
		  ...
		  <td align="left">
            <a href="fill-question.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row6["ID"]; ?>&ExamID=<?php echo $_GET["ExamID"]; ?>" style="font-family:Tahoma; font-weight:bold;">&nbsp;&nbsp;
			  <?php
			    echo $Row["title"]."&nbsp;>&nbsp;";  echo $Row2["title"]."&nbsp;>&nbsp;";
				echo $Row3["title"]."&nbsp;>&nbsp;"; echo $Row4["title"]."&nbsp;>&nbsp;";
		...
		<tr>
		  ...
		  <td align="left">
            <a href="fill-question.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row7["ID"]; ?>&ExamID=<?php echo $_GET["ExamID"]; ?>" style="font-family:Tahoma; font-weight:bold;">&nbsp;&nbsp;
			  <?php
			    echo $Row["title"]."&nbsp;>&nbsp;";  echo $Row2["title"]."&nbsp;>&nbsp;";
				echo $Row3["title"]."&nbsp;>&nbsp;"; echo $Row4["title"]."&nbsp;>&nbsp;";
				echo $Row5["title"]."&nbsp;>&nbsp;"; echo $Row6["title"]."&nbsp;>&nbsp;";
