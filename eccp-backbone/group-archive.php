            ...
            <div class="widget_body">
            	...
            	<table class="activity_datatable" width="100%" border="0" cellspacing="0" cellpadding="8">
                    <tr>
                      ...
                      <!--<th width="28%"><label>Instructor Name</label></th>-->
     ...
     <tr>
        ...
        <td align="center" valign="middle">
        	<span class="data_actions iconsweet">
              <a class="tip_north" original-title="View This Information" href="view-group.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $result["ID"]; ?>">}</a>
              <a class="tip_north" original-title="Edit This Information" href="edit-group.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $result["ID"]; ?>">C</a>
              <a class="tip_north" original-title="Delete This" href="delete-group.php?SESSION=ECCP/novaScoHTTPXMP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $result["ID"]; ?>">X</a></span>        </td>
     </tr>                   
	<?php } ?>
  </table>
    </div>
