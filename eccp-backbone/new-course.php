...
<ul class="form_fields_container">
  <li>
   <label>Course Title</label>
   	<div class="form_input">
    	<input id="title" name="title" class="tip_east" type="text" value="" title="">
    </div>
  </li>
  ...
  <li>
   <label>Course Description</label>
   	<div class="form_input">
      <textarea id="decs" name="decs" class="tip_east">Course Description</textarea>
    </div>
  </li>
  ...
  <li>
   <label>Course Duration</label>
   	<div class="form_input">
    	<input id="duration" name="duration" class="tip_east" type="text" value="6 Months 11 Days Total Hours Is : 110 hours" title="">
    </div>
  </li>
 ...
 <li> 
  <div>
    ...
    <link href="ckeditor/_samples/sample.css" rel="stylesheet" type="text/css" />
        <textarea cols="80" id="cont" name="cont" rows="20">Course Content Here If You Need</textarea>
  ...
  <li>
   <label>Course Fees</label>
   	<div class="form_input">
    	<input id="fees" name="fees" class="tip_east" type="text" value="" title="">
    </div>
  </li>
