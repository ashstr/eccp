 ...
 <div class="one_wrap">
  ...
  <div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span>
              <h5>Group List  Archive By Course </h5>
        </div>
<div class="widget_body">
    ...
    <table class="activity_datatable" width="100%" border="0" cellspacing="0" cellpadding="8">
        <tr>
            ...
            <th width="80%" align="left">Show Group By Course </th>
            </tr>
<?php
 $cleanHTML03 = cleanIt($_GET['T'],'NO_HTML');	
 $catId = intval($cleanHTML03);

 $Sql = mysql_query("select * from `groups` where `courseid` = '$catId' ");

 // echo mysql_num_rows($Sql); exit;
 ...
 if(mysql_num_rows($Sql)!=0){	
   while ($Row = mysql_fetch_array($Sql)){ ?>
		<tr>
		  ...
		  <td align="left">
          	<a href="exam-archive.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row["ID"]; ?>" style="font-family:Tahoma; font-weight:bold;">View Related Exam For This : [ Group ID : <?php echo $Row["UnConID"]; ?> ]</a></td>
		  </tr>
      
 <?php 
   }// End While
   
   } // chack me if you have sub or not
   else{
   	 echo "<script>alert('Sorry, No Group Listed For This Course');</script>"; 
