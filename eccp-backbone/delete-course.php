 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Delete Access - ECCP</h5></div>
			 <?php 
			 if(mysql_query(" delete from `subject` where `ID` = '$URL_ID' ") or die(mysql_error()) ){
			 	echo "<strong>Your Request Has Been Done With Success <br/><br/> * This Course Hase Been Deleted From our Record, And you Can Not Undo this action.</strong>";
			 	}
...
<div class="widget_body">
 ...
 <?php 
	...
	$GetlastUID  = mysql_query("SELECT * FROM `subject` WHERE `ID`= $URL_ID ORDER BY `ID` DESC LIMIT 0 , 1");
	  while( $result = mysql_fetch_array($GetlastUID)){ ?>
     <tr>
       <td align="left">
       <span style="font-style:normal; font-size:14px; font-weight:600; color: #FF0000; ">
       You Will Delete This Course With This Information, Please Be Sure After Deleted You Can Not Undo</span><br/>
       <br/><br/>
