...
<div id="content_wrap">
 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Approve This Valid Exam - ECCP</h5></div>
...
<?php 
 $URL_ID = intval($_GET["id"]); 
	 ...
	 $GetData  = mysql_query("UPDATE `exam_checker` SET `flag` = '0' WHERE `ID` = $URL_ID");
	 if($GetData){
	  	echo "<script>alert('Congratulation, This Process Done With Success');</script>";  ?>
				<script>location.href= "member-vs-exam.php";</script>
				<?php }else{
