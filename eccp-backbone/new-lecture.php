...
<!--One_Wrap-->
  <form name="team" id="team"  action="<?=$_SERVER['PHP_SELF']?>?action=listme" class="" method="post" enctype="multipart/form-data">
 <div class="one_wrap">

  <div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span>
              <h5>The Lecture Schedule</h5>
        </div>
  ...
  <li>
   <label>Set Course</label>
   	<div class="form_input">
    	<select name="class" id="class"  onChange="document.team.submit();">
