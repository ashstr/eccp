...
<!--One_Wrap-->
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Member Archive Access - ECCP</h5></div>
 ...
 <?php 
 	$Comm1 = mysql_query("SELECT * FROM `memeber` ORDER BY `ID` DESC LIMIT 0, 50 ");
