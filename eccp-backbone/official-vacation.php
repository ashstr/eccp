    ...
    <ul class="form_fields_container">
      <li>
       <label>Vacation Title</label>
        <div class="form_input">
            <input id="vacatit" name="vacatit" class="tip_east" type="text" value="" title="Make Sure to Enter Valid Entry">
        </div>
      </li>
      ...
      <li>
       <label>Vacation Description</label>
        <div class="form_input">
            <input id="vacades" name="vacades" class="tip_east" type="text" value="" title="Make Sure to Enter Valid Entry">
        </div>
      </li>
      ...
      <li>
       <label>Vacation Date</label>
        <div class="form_input">
            <input id="vacadate" name="vacadate" class="tip_east" type="text" value="" title="Make Sure to Enter Valid Entry">
        </div>
      </li>
...
<div class="widget_body">
 <!--Activity Table-->   
  <div class="action_bar" align="center">
   <input name="Update" type="submit" value="Record This Now" class="button_small whitishBtn">
