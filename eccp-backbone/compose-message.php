...
<?php if($_REQUEST["action"]=="send"){
	...
	$me 		 = $_SESSION["user_admin"];
		
	$new_message = mysql_query("INSERT INTO `message` (`from`, `to`, `time`, `subject`, `contant`, `flag`, `read`)VALUES('$me', '$to', NOW(), '$subject', '$cont', '1', 'NO')");
		if($new_message){ ?>
 <div class="one_wrap">
...
<?php }// end of check query database
...
<ul class="form_fields_container"><li>
   <label>From :</label>
   	<div class="form_input">
    	<input id="from" name="from" class="tip_east" type="text" value="<?php echo $_SESSION["user_admin_name"]; ?>" title="<?php echo $_SESSION["user_admin_name"]; ?>" style="font-family:Tahoma; border:hidden; background-color:#FFFFFF; " readonly="readonly">
    </div>
  </li>
...
<div class="widget_body">
 <!--Activity Table-->   
  <div class="action_bar" align="center">
   <input name="Update" type="submit" value="Send This Message" class="button_small whitishBtn">
