 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Delete Access From Member Archive - ECCP</h5></div>
			 <?php 
			 if(mysql_query(" delete from `memeber` where `ID` = '$URL_ID' ") or die(mysql_error()) ){
...
<div class="widget_body">
 ...
 <?php 
	...
	$GetlastUID  = mysql_query("SELECT * FROM `memeber` WHERE `ID`= $URL_ID ORDER BY `ID` DESC LIMIT 0 , 1");
