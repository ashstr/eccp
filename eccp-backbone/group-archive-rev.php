     ...
     <tr>
        ...
        <td align="center" valign="middle">
          <span class="data_actions iconsweet">
              ...
              <a class="tip_north" original-title="Delete This" href="delete-group.php?SESSION=ECCP/novaScoHTTPXMP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $result["ID"]; ?>">X</a></span>
           </td>
     </tr>                   
	<?php } ?>
  </table>
