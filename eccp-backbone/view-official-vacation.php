    ...
    <ul class="form_fields_container">
      <li>
       <label>Vacation Title</label>
        <div class="form_input">
            <input id="vacatit" name="vacatit" class="tip_east" type="text" value="<?php echo $GetlastUID2["title"]; ?>" title="" readonly>
        </div>
      </li>
      ...
      <li>
       <label>Vacation Description</label>
        <div class="form_input">
            <input id="vacades" name="vacades" class="tip_east" type="text" value="<?php echo $GetlastUID2["dic"]; ?>" title="" readonly>
        </div>
      </li>
      ...
      <li>
       <label>Vacation Date</label>
        <div class="form_input">
            <input id="vacadate" name="vacadate" class="tip_east" type="text" value="<?php echo $GetlastUID2["date"]; ?>" title="" readonly>
        </div>
      </li>
