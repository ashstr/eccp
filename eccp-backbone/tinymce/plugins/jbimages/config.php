...
| -------------------------------------------------------------------*/
	...
	$config['img_path']    = 'http://eccp.me/ECCP-BackBone/uploaded'; //'../../../../uploaded/'; // Relative to domain name
	$config['upload_path'] = '../../../../uploaded/'; // Physical path. [Usually works fine like this]

//	$config['img_path'] = 'http://localhost/xampp/eccp/ECCP-BackBone/uploaded/'; // Relative to domain name
