...
<!--One_Wrap-->
 ...
 <?php 
     ...
     <tr>
        ...
        <td align="center" valign="middle"><span class="data_actions iconsweet"><a class="tip_north" original-title="Edit Admin Authority" href="edit-authority.php?valve=<?php echo $result["ID"]; ?>">C</a></span></td>
      </tr>                   
	<?php } ?>
  </table>
