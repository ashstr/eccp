...
<!--One_Wrap-->
 ...
 <div class="one_wrap">
  ...
  <div class="widget">
        	...
        	<h5>Select Course To View Exam Archive Access - ECCP</h5>
        </div>
   ...
   while ($Row = mysql_fetch_array($Sql)){
	  $ID_main=$Row["ID"]; ?>
		<tr>
		  ...
		  <td align="left">
          	<a href="exam-archive-sub.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row["ID"]; ?>" style="font-family:Tahoma; font-weight:bold;"><?php echo $Row["title"]; ?></a></td>
