   ...
   while ($Row = mysql_fetch_array($Sql)){
	  $ID_main=$Row["ID"]; ?>
		<tr>
		  ...
		  <td align="left"><a href="#" style="font-family:Tahoma; font-weight:bold;"><?php echo $Row["title"]; ?></a></td>
		  ...
		  <a class="tip_north" original-title="Edit This Information" href="edit-course.php?valve=<?php echo $Row["ID"]; ?>">C</a>
