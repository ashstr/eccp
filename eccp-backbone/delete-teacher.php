 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Delete Access From Member Archive - ECCP</h5></div>
			 <?php 
			 if(mysql_query(" delete from `teacher` where `ID` = '$URL_ID' ") or die(mysql_error()) ){
...
<!--One_Wrap-->
 <div class="one_wrap">
    	<div class="widget">
        	...
        	<h5>Delete Access From Teacher Archive - ECCP </h5>
       	  </div>
...
<div class="widget_body">
 ...
 <?php 
	...
	$GetlastUID  = mysql_query("SELECT * FROM `teacher` WHERE `ID`= $URL_ID ORDER BY `ID` DESC LIMIT 0 , 1");
	  while( $result = mysql_fetch_array($GetlastUID)){ ?>
     <tr>
       <td align="left">
       <span style="font-style:normal; font-size:14px; font-weight:600; color: #FF0000; ">
       You Will Delete This Member Who Have This Information, Please Be Sure After Deleted You Can Not Undo</span><br/><br/><br/>
       Name : <?php echo $result["name"]; ?><br/><br/>
       University : <?php echo $result["univ"]; ?><br/><br/>
       Email : <?php echo $result["email"]; ?><br/><br/>
       Mobile Number : <?php echo $result["mobile"]; ?><br/><br/>
