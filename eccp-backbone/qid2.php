...
while ($Row2 = mysql_fetch_array($Result2)){
   ...
   <li>
	 ...
	 <textarea name="ques" id="ques" rows="8" cols="60">Enter Question Here</textarea>
  ...
  CKEDITOR.replace( 'ques',
{
  ...
  <li>
    	...
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">C</span><h5>Answer Explanation [ Assurance ]</h5></div>
            <div class="widget_body">
                <div id="container">
                	
                    <textarea name="Explanation" id="Explanation" rows="8" cols="60">Answer Explanation [ Assurance ]</textarea>
<!--<script type="text/javascript" src="<?php //echo $domain_site; ?>ckeditor/ckeditor.js?t=A06B"></script>
<script type="text/javascript">
...
<?php
  ...
  <li>
   <label>Tips & Help</label>
     <div class="form_input">
     <textarea name="tips" id="tips" cols="10" rows="5"  class="tip_east">Sorry No Help Or Tips Was Specify For This Question</textarea>
     </div>
  </li>                    
