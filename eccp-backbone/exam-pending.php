    	...
    	<div class="widget">
            ...
            <div class="widget_body">
            	...
            	<table class="activity_datatable" width="100%" border="0" cellspacing="0" cellpadding="8">
                    <tr>
                        <th width="6%">ID</th>
                      <th width="41%">Exam Titile</th>
                      <th width="9%">time / Minutes</th>
                      <th width="16%">add date</th>
                      <th width="11%">author</th>
                      <th width="7%">status</th>
                        <th width="10%">Actions</th>
                  </tr>
 <?php 
 	$Comm1 = mysql_query("SELECT * FROM `exam` WHERE `pending` = '0' LIMIT 0, 50 ");
     ...
     <tr>
	  ...
	  echo  html_entity_decode($valv);
		  ?></td>
        <td align="center"><?php if($result["author"]== ""){ echo "Not Define"; }else{ echo $result["exam_period"]; } ?>&nbsp;</td>
        ...
        <a class="tip_north" original-title="Approve This Valid Question" href="valid-exam.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $result["ID"]; ?>">=</a>
