...
<?php if($_REQUEST["action"]=="update"){
	   		include("action-new-revcourse.php");
		}else{  ?>
  ...
  <li>
   <label>Subject Title</label>
   	<div class="form_input">
    	<input id="rev" name="rev" class="tip_east" type="text" value="REV" title="" style="width:25px;" disabled>&nbsp; - &nbsp;<input id="title" name="title" class="tip_east" type="text" value="" title="Make Sure to enter valid entry" style="width:90%;">
    </div>
  </li>
  
<li>
   <label>Select Basic Course</label>
     <div class="form_input">
...
<div class="widget_body">
 <!--Activity Table-->   
  <div class="action_bar" align="center">
   <input name="Update" type="submit" value="Record New Course" class="button_small whitishBtn">
