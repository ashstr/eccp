   ...
   while ($Row = mysql_fetch_array($Sql)){
	  $ID_main=$Row["ID"]; ?>
		<tr>
		  ...
		  <a class="tip_north" original-title="View Details" href="view-course.php?valve=<?php echo $Row["ID"]; ?>" target="_blank">`</a>
		  <a class="tip_north" original-title="Edit This Information" href="edit-official-vacation.php?valve=<?php echo $Row["ID"]; ?>">C</a>
		  <a class="tip_north" original-title="Delete This" href="delete-course.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row["ID"]; ?>">X</a>
		  </span></td>
        </tr>
		...
		<tr>
		  ...
		  <a class="tip_north" original-title="View Details" href="view-course.php?valve=<?php echo $Row2["ID"]; ?>" target="_blank">`</a>
		  <a class="tip_north" original-title="Edit This Information" href="edit-official-vacation.php?valve=<?php echo $Row2["ID"]; ?>">C</a>
		  <a class="tip_north" original-title="Delete This" href="delete-course.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row2["ID"]; ?>">X</a>
		  </span></td>
        </tr>
		<?php 
	...
	$ID_main=$Row3["ID"];?>
		<tr>
		  <td align="left"><?php echo $Row3["ID"]; ?></td>
		  <td align="left">
		  ...
		  <td align="left"><span class="data_actions iconsweet">
		  <a class="tip_north" original-title="View Details" href="view-course.php?valve=<?php echo $Row3["ID"]; ?>" target="_blank">`</a>
		  <a class="tip_north" original-title="Edit This Information" href="edit-official-vacation.php?valve=<?php echo $Row3["ID"]; ?>">C</a>
		  <a class="tip_north" original-title="Delete This" href="delete-course.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row3["ID"]; ?>">X</a>
		  </span></td>
        </tr>
		...
		while ($Row4 = mysql_fetch_array($Result4)){
			$ID_main=$Row4["ID"]; ?>
		<tr>
		  <td align="left"><?php echo $Row4["ID"]; ?></td>
		  <td align="left">
            <a href="#" style="font-family:Tahoma;">&nbsp;&nbsp;
		  ...
		  <td align="left"><span class="data_actions iconsweet">
		  <a class="tip_north" original-title="View Details" href="view-course.php?valve=<?php echo $Row4["ID"]; ?>" target="_blank">`</a>
		  <a class="tip_north" original-title="Edit This Information" href="edit-official-vacation.php?valve=<?php echo $Row4["ID"]; ?>">C</a>
		  <a class="tip_north" original-title="Delete This" href="delete-course.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row4["ID"]; ?>">X</a>
		  </span></td>
        </tr>
		<?php 
		...
		<tr>
		  ...
		  <td align="left"><span class="data_actions iconsweet">
		  <a class="tip_north" original-title="View Details" href="view-course.php?valve=<?php echo $Row5["ID"]; ?>" target="_blank">`</a>
		  <a class="tip_north" original-title="Edit This Information" href="edit-official-vacation.php?valve=<?php echo $Row5["ID"]; ?>">C</a>
		  <a class="tip_north" original-title="Delete This" href="delete-course.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $Row5["ID"]; ?>">X</a>
		  </span></td>
        </tr>
		<?php 
