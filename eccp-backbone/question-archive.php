...
<!--One_Wrap-->
 ...
 <?php 
 	$Comm1 = mysql_query("SELECT * FROM `questions` WHERE `cat` = '$catId' AND `pending` != 0 LIMIT 0, 50 ");
	  ...
	  echo  html_entity_decode($valv);
        ...
        <td align="center">
        	<span class="data_actions iconsweet">
            	<a class="tip_north" original-title="View Full Question" href="details-question.php?SESSION=ECCP&=SESSIONID=<?php echo rand(11111, 99999); ?>&T=<?php echo $result["ID"]; ?>" target="_blank">}</a>
