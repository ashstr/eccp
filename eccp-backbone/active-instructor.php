...
<div id="content_wrap">
 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Change Case Of This Instructor - ECCP</h5></div>
<div class="widget_body">
  ...
  <td align="left">
<?php 
 $InstrID = intval($_GET["T"]);  
	 
	 $GetData  = mysql_query("UPDATE `teacher` SET `flag` = '1' WHERE `ID` = '$InstrID' ") or die(mysql_error());
	 if($GetData){
