...
<div id="content_wrap">
 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Approve This Valid Question Archive - ECCP</h5></div>
...
<?php 
 $URL_ID = intval($_GET["T"]); 
	 ...
	 $GetData  = mysql_query("UPDATE `questions` SET `pending` = '1' WHERE `ID` = $URL_ID");
	 if($GetData){
	  	echo "<script>alert('Congratulation, This Process Done With Success');</script>";  ?>
				<script>location.href= "question-pending.php";</script>
				<?php }else{
