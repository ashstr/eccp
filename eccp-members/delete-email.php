...
<?php 
 ...
 <div class="one_wrap">
    	<div class="widget">
        	<div class="widget_title"><span class="iconsweet">f</span><h5>Delete Personal Message - ECCP - NovaScotia</h5></div>
			 <?php 
			 if(mysql_query(" delete from `message` where `ID` = '$URL_ID' ") or die(mysql_error()) ){
			 	echo "<strong>Your Request Has Been Done With Success <br/><br/> * This Message Hase Been Deleted From our Record, And you Can Not Undo this action.</strong>";
			 	}
...
<!--One_Wrap-->
 <div class="one_wrap">
    	<div class="widget">
        	...
        	<h5>Delete Access From Member Archive - ECCP </h5>
       	  </div>
...
<div class="widget_body">
 ...
 <?php 
	...
	$GetlastUID  = mysql_query("SELECT * FROM `message` WHERE `ID`= $URL_ID ORDER BY `ID` DESC LIMIT 0 , 1");
	  while( $result = mysql_fetch_array($GetlastUID)){ ?>
     <tr>
       <td align="left">
                <?php
	   $com02 = mysql_query("SELECT `UID`, `name` FROM `memeber` WHERE `UID` = $result[from] ");
       ...
       You Will Delete This Message Who Have This Information, Please Be Sure After Deleted You Can Not Undo</span><br/><br/><br/>
       <strong>From</strong> : <p style="font-family:Tahoma;">&nbsp;&nbsp;&nbsp;<?php echo $res; ?></p>
       <strong>Subject</strong> :  <p style="font-family:Tahoma;">&nbsp;&nbsp;&nbsp;<?php echo $result["subject"]; ?></p>
       <strong>Date</strong> :  <p style="font-family:Tahoma;">&nbsp;&nbsp;&nbsp;<?php echo $result["time"]; ?></p><br/><br/><br/><br/>       
       </td>
     </tr>
