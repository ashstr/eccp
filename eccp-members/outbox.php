...
<!--One_Wrap-->
 ...
 echo $com03["UID"]."&nbsp; - &nbsp;"; echo $com03["name"]; ?></td>
        <td align="center"><span class="data_actions iconsweet"><!--<a class="tip_north" original-title="Delete This Question" href="delete-email.php?SESSION=ECCP&=SESSIONID=<?php //echo rand(11111, 99999); ?>&T=<?php //echo $result["ID"]; ?>">--><a class="tip_north" original-title="Delete This Message" href="#">X</a></span></td>
      </tr>                   
	<?php } ?>
  </table>
